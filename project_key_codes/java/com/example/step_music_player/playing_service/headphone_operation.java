...
public class headphone_operation extends BroadcastReceiver {
    private Context context;
    private Timer timer = new Timer();
    private static int clickCount;
    private static onHeadsetListener headsetListener;

    public headphone_operation(){
        super();
    }

    public headphone_operation(Context context){
        super();
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                if (msg.what == 1) { headsetListener.playOrPause(); }
                else if(msg.what == 2){ headsetListener.playNext(); }
                else if(msg.what == 3){ headsetListener.playPrevious(); } }
    ...
    public void registerHeadsetReceiver() {
        ...
        ComponentName name = new ComponentName(context.getPackageName(),headphone_operation.class.getName());
